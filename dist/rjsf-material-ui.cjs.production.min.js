...
var t = require('react-jsonschema-form'),
  ...
  B = e(require('@material-ui/core/Slider')),
  W = e(require('@material-ui/core/MenuItem')),
...
var N = function(e) {
  ...
  P = b.makeStyles({ root: { marginTop: 5 } }),
  G = {
    ...
    SelectWidget: function(e) {
      ...
      return r.createElement(
        y,
        {
          fullWidth: !0,
          required: a,
          variant: p.muiOptions && p.muiOptions.fieldVariant,
        },
        r.createElement(S, { shrink: !0, htmlFor: i }, e.label || t.title),
        r.createElement(
          D,
          {
            multiple: void 0 !== c && c,
          ...
          v.map(function(e, t) {
            var i = e.value,
              n = e.label,
              a = h && -1 != h.indexOf(i);
            return r.createElement(W, { key: t, value: i, disabled: a }, n);
          })
        )
      );
    },
